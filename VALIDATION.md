...
- **Run:** 2026-09-03T05:10:40.369Z through 2026-09-03T05:10:44.503Z
- **Overall:** PASS
- **Tax years:** 1975-2026
- **Shared vectors:** 235
- **Node:** v22.22.2
...
| Strict TypeScript typecheck | PASS | 0 | 176 ms |
| TypeScript unit and conformance tests | PASS | 0 | 820 ms |
| PHP engine syntax | PASS | 0 | 49 ms |
| PHP unit-test syntax | PASS | 0 | 25 ms |
| PHP conformance-test syntax | PASS | 0 | 32 ms |
| PHP parity runner syntax | PASS | 0 | 24 ms |
| PHP unit tests | PASS | 0 | 42 ms |
| PHP conformance vectors | PASS | 0 | 69 ms |
| ESM, CommonJS, and declaration build | PASS | 0 | 1252 ms |
| ESM/CommonJS smoke imports | PASS | 0 | 70 ms |
| Complete TypeScript/PHP output parity | PASS | 0 | 221 ms |
| Built-package manifest validation | PASS | 0 | 70 ms |
| npm package dry run | PASS | 0 | 404 ms |
| Composer manifest validation | PASS | 0 | 453 ms |
...
```text
Canonical data validation passed: 52 contiguous retirement tax years, 23 contiguous HSA tax years, 45 contiguous FSA tax years, 70 sources, 235 conformance vectors.
```
...
235 conformance vectors, 0 failed
```
...
```text
TypeScript/PHP full-output parity passed for 235 vectors.
```
...
[
  {
    ...
    "version": "0.3.0",
    "size": 298141,
    "unpackedSize": 2280849,
    "shasum": "118b84e98391940443524513b114c1e5896c7103",
    "integrity": "sha512-KChXOIxupdNnrgnY0f2lV1TeqKCvpgd2HBeNqlHXOoV6Q/vXPYkKiNKlaQ/HWkNoVNZ175rdTUIpbUVj+fw80Q==",
