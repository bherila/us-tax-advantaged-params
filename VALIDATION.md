...
- **Run:** 2026-09-02T05:27:20.822Z through 2026-09-02T05:27:26.605Z
- **Overall:** PASS
- **Tax years:** 1975-2026
- **Shared vectors:** 192
- **Node:** v22.22.2
...
| Generated native parameter blocks | PASS | 0 | 106 ms |
| Source manifests and publication files | PASS | 0 | 93 ms |
| Strict TypeScript typecheck | PASS | 0 | 337 ms |
| TypeScript unit and conformance tests | PASS | 0 | 1277 ms |
| PHP engine syntax | PASS | 0 | 54 ms |
| PHP unit-test syntax | PASS | 0 | 41 ms |
| PHP conformance-test syntax | PASS | 0 | 45 ms |
| PHP parity runner syntax | PASS | 0 | 45 ms |
| PHP unit tests | PASS | 0 | 69 ms |
| PHP conformance vectors | PASS | 0 | 109 ms |
| ESM, CommonJS, and declaration build | PASS | 0 | 1769 ms |
| ESM/CommonJS smoke imports | PASS | 0 | 99 ms |
| Complete TypeScript/PHP output parity | PASS | 0 | 276 ms |
| Built-package manifest validation | PASS | 0 | 94 ms |
| npm package dry run | PASS | 0 | 611 ms |
| Composer manifest validation | PASS | 0 | 283 ms |
...
```text
Canonical data validation passed: 52 contiguous retirement tax years, 23 contiguous HSA tax years, 45 contiguous FSA tax years, 70 sources, 192 conformance vectors.
```
...
192 conformance vectors, 0 failed
```
...
```text
TypeScript/PHP full-output parity passed for 192 vectors.
```
...
[
  {
    ...
    "version": "0.3.0",
    "size": 275046,
    "unpackedSize": 2187320,
    "shasum": "c398ed634218a718600f273b83eb4865878c9b51",
    "integrity": "sha512-5LwdkUJsbzFfBibyl/VYskzBXRRfzDWdJiJsQmyO+wZbLvJuDA37kggi0/OYplkQWOX7UIqIf4DDLJqLkeGVMw==",
