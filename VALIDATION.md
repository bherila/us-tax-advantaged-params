...
- **Run:** 2026-09-02T08:50:02.353Z through 2026-09-02T08:50:06.278Z
- **Overall:** PASS
- **Tax years:** 1975-2026
- **Shared vectors:** 228
- **Node:** v22.22.2
...
|---|---:|---:|---:|
| Canonical parameter and vector validation | PASS | 0 | 66 ms |
| Generated native parameter blocks | PASS | 0 | 97 ms |
| Source manifests and publication files | PASS | 0 | 64 ms |
| Strict TypeScript typecheck | PASS | 0 | 178 ms |
| TypeScript unit and conformance tests | PASS | 0 | 924 ms |
| PHP engine syntax | PASS | 0 | 38 ms |
| PHP unit-test syntax | PASS | 0 | 28 ms |
| PHP conformance-test syntax | PASS | 0 | 27 ms |
| PHP parity runner syntax | PASS | 0 | 25 ms |
| PHP unit tests | PASS | 0 | 41 ms |
| PHP conformance vectors | PASS | 0 | 62 ms |
| ESM, CommonJS, and declaration build | PASS | 0 | 1175 ms |
| ESM/CommonJS smoke imports | PASS | 0 | 63 ms |
| Complete TypeScript/PHP output parity | PASS | 0 | 211 ms |
| Built-package manifest validation | PASS | 0 | 58 ms |
| npm package dry run | PASS | 0 | 446 ms |
| Composer manifest validation | PASS | 0 | 156 ms |
...
```text
Canonical data validation passed: 52 contiguous retirement tax years, 23 contiguous HSA tax years, 45 contiguous FSA tax years, 70 sources, 228 conformance vectors.
```
...
228 conformance vectors, 0 failed
```
...
```text
TypeScript/PHP full-output parity passed for 228 vectors.
```
...
[
  {
    ...
    "version": "0.3.0",
    "size": 296281,
    "unpackedSize": 2273113,
    "shasum": "799ab84a64214de62acfb1e03e428d1cabc4e497",
    "integrity": "sha512-7kR/CCFhwAN6H0oFHhEqLkNo2pV+xrAkFqqodyThmRRayDhRVEAMJLG2vDlmQLi2oZFtc2x8DwCY5JJ3AXFy5A==",
