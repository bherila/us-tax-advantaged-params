...
- **Run:** 2026-09-03T06:53:41.769Z through 2026-09-03T06:53:46.755Z
- **Overall:** PASS
- **Tax years:** 1975-2026
- **Shared vectors:** 244
- **Node:** v22.22.2
...
| Source manifests and publication files | PASS | 0 | 74 ms |
| Strict TypeScript typecheck | PASS | 0 | 259 ms |
| TypeScript unit and conformance tests | PASS | 0 | 1006 ms |
| PHP engine syntax | PASS | 0 | 44 ms |
| PHP unit-test syntax | PASS | 0 | 35 ms |
| PHP conformance-test syntax | PASS | 0 | 34 ms |
| PHP parity runner syntax | PASS | 0 | 34 ms |
| PHP unit tests | PASS | 0 | 52 ms |
| PHP conformance vectors | PASS | 0 | 85 ms |
| ESM, CommonJS, and declaration build | PASS | 0 | 1490 ms |
| ESM/CommonJS smoke imports | PASS | 0 | 83 ms |
| Complete TypeScript/PHP output parity | PASS | 0 | 297 ms |
| Built-package manifest validation | PASS | 0 | 80 ms |
| npm package dry run | PASS | 0 | 530 ms |
| Composer manifest validation | PASS | 0 | 417 ms |
...
```text
Canonical data validation passed: 52 contiguous retirement tax years, 23 contiguous HSA tax years, 45 contiguous FSA tax years, 70 sources, 244 conformance vectors.
```
...
244 conformance vectors, 0 failed
```
...
```text
TypeScript/PHP full-output parity passed for 244 vectors.
```
...
[
  {
    ...
    "version": "0.3.0",
    "size": 300151,
    "unpackedSize": 2290930,
    "shasum": "2f94547f73f1d5a986d431fd6aded5438c4e893d",
    "integrity": "sha512-CBqV1dYK5ooPRfAW/HDDHiRUcjWmzcFJRfhzIkudbmeoldQb/Oug1qHr3sGYzwtHhWFujlKHHmvL3vF/tjuEwQ==",
