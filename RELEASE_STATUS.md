...
## us-tax-advantaged-params@0.2.0

**Local validation:** PASS

The engines encode 1975-2026, include 149 shared conformance vectors, and produce ESM, CommonJS, declaration, and native PHP artifacts.
