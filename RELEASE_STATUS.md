...
## us-tax-advantaged-params@0.5.0

**Local validation:** PASS

The engines encode 1975-2026, include 596 shared conformance vectors, and produce ESM, CommonJS, declaration, and native PHP artifacts.
